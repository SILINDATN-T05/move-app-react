...
onViewWorkshop() {
  ...
  render() {
    ...
    return (
      <div>
      <Modal isOpen={this.state.edit} toggle={this.onEditWorkshop}
             className={'modal-lg '}>
        ...
        <Modal isOpen={this.state.view_workshop} toggle={this.onViewWorkshop}
                className={'modal-lg '}>
            ...
            <Card>
              ...
              <CardBody>
                ...
                <InputGroup className="mb-3" style={{width: 350}}>
                  ...
                  <Input type="text" name='search' value={this.state.search} onChange={this.handleChange} placeholder="Work Shop Id" />
               ...
               <p></p>
                <Modal isOpen={this.state.large} toggle={this.onAddWorkShop}
                       className={'modal-lg '}>
                  <ModalHeader toggle={this.onAddWorkShop}>Add Work Shop</ModalHeader>
                  <ModalBody>
