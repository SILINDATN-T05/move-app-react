...
onViewOrder() {
  ...
  render() {
    ...
    return (
      <div>
      <Modal isOpen={this.state.edit} toggle={this.onEditOrder}
             className={'modal-lg '}>
        ...
        <Modal isOpen={this.state.view_order} toggle={this.onViewOrder}
                className={'modal-lg '}>
          <ModalHeader toggle={this.onViewOrder}>View Order</ModalHeader>
          <ModalBody>
...
handleSelect(e) {
  ...
  return (
    ...
    <CardHeader>
        <i className="fa fa-align-justify"></i> Work Shop Details <small>Date: <b>{this.state.requestedDate}</b></small> 
    </CardHeader>
    <CardBody>
    ...
    <Card className="p-4" style={{height: 285, top:-10}}>
    <CardHeader>
          ...
          <Col xl={12}>
            <Card>
              ...
              <CardBody>
               ...
               <p></p>
                <Modal isOpen={this.state.large} toggle={this.onAddOrder}
                       className={'modal-lg '}>
