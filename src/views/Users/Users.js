...
class SimpleMenu extends React.Component {
  ...
  this.state['type'] = props.user.branchId !== null ? 'Branch': props.user.supplierId !== null ? 'Supplier': 'Work Shop';
...
onInvokeAssignRole() {
  ...
  render() {
    ...
    return (
      <div>
      <Modal isOpen={this.state.edit} toggle={this.onEditUser}
             className={'modal-lg '}>
        ...
        <Modal isOpen={this.state.invoke_assign} toggle={this.onInvokeAssignRole}
                className={'modal-lg '}>
...
handleType(e) {
  const data = { 
    ...
    workshop: {type: 'Work Shop', type_value: 'workshop'}
  }
  const { name } = e.target;
  ...
  return (
    <div>
      <ButtonGroup>
        ...
        <Button name='workshop' onClick={this.handleType}>Work Shop</Button>
      </ButtonGroup>
      <InputGroup className="mb-3">
        <InputGroupAddon addonType="prepend">
          <InputGroupText>
          ...
          <Col xl={12}>
            <Card>
              ...
              <CardBody>
               ...
               <p></p>
                <Modal isOpen={this.state.large} toggle={this.onAddUser}
                       className={'modal-lg '}>
