...
onViewSupplier() {
  ...
  render() {
    ...
    return (
      <div>
      <Modal isOpen={this.state.edit} toggle={this.onEditSupplier}
             className={'modal-lg '}>
        ...
        <Modal isOpen={this.state.view_supplier} toggle={this.onViewSupplier}
                className={'modal-lg '}>
          <ModalHeader toggle={this.onViewSupplier}>View Supplier</ModalHeader>
          <ModalBody>
          ...
          <Col xl={12}>
            <Card>
              ...
              <CardBody>
               ...
               <p></p>
                <Modal isOpen={this.state.large} toggle={this.onAddSupplier}
                       className={'modal-lg '}>
